...
load_dotenv(os.path.join(env_file, ".env"))
...
class Settings(BaseSettings):
    ...
    DATABASE: str = os.environ.get("DATABASE_CONNECTION", "postgresql+psycopg2")   # PostgreSQL
    ...
    DATABASE_PASS: str = os.environ.get("DATABASE_PASSWORD", "")
